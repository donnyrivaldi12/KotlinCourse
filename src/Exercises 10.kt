fun main(){
    ...
    val nullableString: List<String?>? = nameOfAnimals
    //nullableString = null
    println(nullableString)
    println(nullableString!![2])
    println()

    val nullableInteger: List<Int?>? = mutableListOf(10,20,30,40)
    //nullableInteger = null
    println(nullableInteger)
    println(nullableInteger!![1])
    println()

    val nullableFloat: List<Float?>? = mutableListOf(1f,2f,3f,4f)
    //nullableFloat = null
